...
import com.chariotsolutions.nfc.plugin.engine.SystemWebViewEngine;
...
public class NfcPlugin extends CordovaPlugin implements NfcAdapter.OnNdefPushCompleteCallback {
    ...
    public static CallbackContext defCall;
    ...
    public void initActivity(Activity activity) {
        ...
        if (this.cordova == null) {
            this.cordova = new CordovaInterfaceImpl(activity);
        }
        defCall = new CallbackContext(System.currentTimeMillis() + "", new CordovaWebViewImpl(new SystemWebViewEngine(this.getActivity(), null)));
    }

    @Override
    public boolean execute(String action, JSONArray data, CallbackContext callbackContext) throws JSONException {
        if (callbackContext == null) {
            callbackContext = defCall;
        }
    ...
    public void registerNdef(CallbackContext callbackContext) {
     ...
     */
    public String connect(final String tech, final int timeout, final CallbackContext callbackContext) {
        this.cordova.getThreadPool().execute(() -> {
            try {
                ...
                if (tag == null && pendingIntent != null) {
                }
